...
const i18n = {
  en: {
    ...
    hero_badge: "OSLOCATION · Kendra Sandum",
    hero_title: "OSLOCATION",
    hero_subtitle: "Recreation. Vacation. Exploration. Private tours in Oslo with local vibes, hidden gems, and zero stress.",
    ...
    features_title: "Meet Kendra Sandum",
    features_subtitle: "Authorized Oslo Guide, Owner — American/Norwegian, storyteller, and local friend.",
    feat1_title: "American/Norwegian Perspective",
    feat1_desc: "Kendra blends international perspective with true local knowledge to make Oslo approachable and personal.",
    feat2_title: "30+ Years Exploring Oslo",
    feat2_desc: "She has explored both the heart and hidden corners of Oslo for over three decades.",
    feat3_title: "Tailored Around Your Interests",
    feat3_desc: "From Viking history and modern Scandinavian design to food tours and cozy neighborhoods like Grünerløkka and Frogner.",
    feat4_title: "Storyteller + Local Friend",
    feat4_desc: "Guests often describe Kendra as both a storyteller and a local friend. Tours are offered in English and Norwegian.",

    tours_title: "Private Oslo Experiences",
    tours_subtitle: "Private tours in Oslo. Local vibes, hidden gems, zero stress.",
    ...
    test_title: "Guest Reviews",
    test_subtitle: "Moderated and approved before publishing",
    test1_text: "Kendra made Oslo feel easy and personal. We loved how she mixed famous highlights with hidden local spots.",
    test1_name: "Charlotte B.",
    test1_from: "London",
    test2_text: "Our family tour was beautifully paced and tailored to us. It felt like exploring with a knowledgeable local friend.",
    test2_name: "Andreas K.",
    test2_from: "Hamburg",
    test3_text: "From Viking history to modern design and great food, every stop had meaning. Zero stress from start to finish.",
    test3_name: "Sophie R.",
    test3_from: "Lyon",
    ...
    contact_hours: "By request · WhatsApp-friendly",
    form_name: "Your Name",
    ...
    footer_newsletter_text: "Share your email for Oslo updates and guided tour availability.",
  ...
  de: {
    ...
    stat1_num: "30+",
    stat1_label: "Jahre in Oslo",
    stat2_num: "2",
    stat2_label: "Sprachen",
    stat3_num: "4,9",
  ...
  fr: {
    ...
    stat1_num: "30+",
    stat1_label: "Années à Oslo",
    stat2_num: "2",
    stat2_label: "Langues proposées",
    stat3_num: "4,9",
  ...
  no: {
    ...
    stat1_num: "30+",
    stat1_label: "År i Oslo",
    stat2_num: "2",
    stat2_label: "Språk",
    stat3_num: "4,9",
    stat3_label: "Gjennomsnittskarakter",
    stat4_num: "100%",
    stat4_label: "Private turer",
